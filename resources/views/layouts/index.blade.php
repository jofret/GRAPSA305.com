                ...
                <nav class="navbar">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="#home" class="navbar-brand"><img src="assest/img/logo.png" width="70%" alt="logo"></a>
                        </div>
                        ...
                        <div class="row flex-v-center">
                            <div class="col-md-8 col-lg-7 col-sm-12 col-xs-12">
                                <div class="welcome-text">
                                    <h1>Agendas y planers</h1>
                                    <p>Nos dedicamos a la edición de libros de ayuda y superación personal, tanto de niños, jóvenes y adultos.</p>
                                    <div class="home-button">
                                        <!-- <form action="#">
                                            <input type="search" name="search" id="search" placeholder="Search Courses">
                                            <button type="submit"><i class="fa fa-search"></i></button>
                                        </form> -->
                                        <button type="button" class="btn btn-success btn-lg">Click <i class="lni-whatsapp"></i> WhatsApp</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row flex-v-center">
                            <div class="col-md-8 col-lg-7 col-sm-12 col-xs-12">
                                <div class="welcome-text">
                                    <h1>Marketing</h1>
                                    <p>Dentro de nuestra especialidad está la creación, elaboración o reconstrucción del logotipo de la empresa.</p>
                                    <div class="home-button">
                                        <!-- <form action="#">
                                            <input type="search" name="search" id="search" placeholder="Search Courses">
                                            <button type="submit"><i class="fa fa-search"></i></button>
                    ...
                    <div class="container">
                        <div class="row flex-v-center">
                            <div class="col-md-8 col-lg-7 col-sm-12 col-xs-12">
                                <div class="welcome-text">
                                    <h1>Libros</h1>
                                    <p>Grabaciones en relieve, al fuego o huecograbado, usando las últimas técnicas de impresión</p>
                                    <div class="home-button">
                                        <!-- <form action="#">
                                            <input type="search" name="search" id="search" placeholder="Search Courses">
                                            <button type="submit"><i class="fa fa-search"></i></button>
            ...
            <div class="row promo-content">
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="text-icon-box relative mb20 xs-mb0 wow fadeInUp padding30" data-wow-delay="0.3s">
                        ...
                        <h3 class="box-title">Agendas y planers</h3>
                        <p>Grabaciones en relieve, al fuego o huecograbado, usando las últimas técnicas de impresión</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
            ...
            <div class="row flex-v-center">
                <div class="col-md-5 col-lg-5 col-sm-12 col-xs-12">
                    <div class="about-content xs-mb50 wow fadeIn">
                        <h3 class="xs-font20 mb30">GRAPSA</h3>
                        <p>Nuestra empresa fue creada en el año 1982 en la ciudad de Lima, Perú. Nuestros primeros trabajos fueron de impresiones gráficas, luego incursionamos en la fabricación de agendas, planners de escritorio, directorios telefónicos, y journals. 
Nos sentimos muy complacidos por haber elaborado el libro de oro para el Papa Juan Pablo II, por encargo de la Sociedad Nacional de Industrias y Finas Encuadernaciones. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-md-offset-1 col-lg-offset-1 col-sm-12 col-xs-12">
                    <div class="video-promo-details wow fadeIn">
                        <div class="video-promo-content">
                            <span data-video-id="SyxLVUf6ank" class="video-area-popup mb30"><i class="fa fa-play"></i></span>
                        </div>
                        <img src="assest/img/about/nosotros.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 col-sm-12 col-xs-12">
                    <div class="area-title text-center wow fadeIn">
                        <h2 class="xs-font26">Nuestros Productos</h2>
                    </div>
                </div>
            </div>
            <div class="row course-list">
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-course mb20">
                        <img src="assest/img/course/blok-1.jpg" alt="">
                        <div class="course-details padding30">
                            <h3 class="font18">Su Tiempo es Oro</h3>
                            <p>Manual práctico de como administrar su tiempo. El tiempo es vida...</p><br>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-course mb20">
                        <img src="assest/img/course/blok-2.jpg" alt="">
                        <div class="course-details padding30">
                            <h3 class="font18">Valores y Urbanidad</h3>
                            <p>Es indispensable que la persona conozca el bien, ame el bien y haga el bien...</p><br>
                            <button type="button" class="btn btn-success btn-lg">Click <i class="lni-whatsapp"></i> WhatsApp</button>
                            <!-- <p class="mt30"><a href="#" class="enroll-button">Enroll the Courses</a> <span class="course-price"></span></p> -->
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-course mb20">
                        <img src="assest/img/course/blok-3.jpg" alt="">
                        <div class="course-details padding30">
                            <h3 class="font18">Recetas Comida Peruana</h3>
                            <p>Las mejores recetas de la comida peruana. Una delicia para el paladar...</p><br>
                            <button type="button" class="btn btn-success btn-lg">Click <i class="lni-whatsapp"></i> WhatsApp</button>
                            <!-- <p class="mt30"><a href="#" class="enroll-button">Enroll the Courses</a> <span class="course-price"></span></p> -->
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-course mb20">
                        <img src="assest/img/course/blok-4.jpg" alt="">
                        <div class="course-details padding30">
                            <h3 class="font18">Agendas y Planners</h3>
                            <p>Encuentra tu método perfecto para organizarte. El éxito es la suma de pequeños esfuerzos...</p><br>
                            <button type="button" class="btn btn-success btn-lg">Click <i class="lni-whatsapp"></i> WhatsApp</button>
                            <!-- <p class="mt30"><a href="#" class="enroll-button">Enroll the Courses</a> <span class="course-price"></span></p> -->
                        </div>
                    </div>
            ...
            <div class="row no-margin">
                <div class="no-padding col-md-6 col-lg-6 col-sm-12 col-xs-12">
                   <!--  <div class="map-area relative">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3902.0072545543676!2d-77.04615958464906!3d-12.043021245111065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c8cd69339ddd%3A0x1f36cd7deb0ef3b8!2sAv.%20Argentina%20144%2C%20Cercado%20de%20Lima%2015079%2C%20Per%C3%BA!5e0!3m2!1ses-419!2sar!4v1573222875793!5m2!1ses-419!2sar" width="800" height="600" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                </div>
